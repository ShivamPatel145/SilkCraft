  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-smooth focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        accent: "border-transparent gradient-accent text-accent-foreground shadow-glow",
        premium: "border-transparent bg-accent text-accent-foreground hover:bg-accent/90 shadow-glow",
      },
    },
    defaultVariants: {
      variant: "default",
